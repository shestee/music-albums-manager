...
public class AlbumController {
    ...
    public String showSongsFromAlbum(@RequestParam("albumId") int albumId, Model theModel) {
        ...
        Song song = new Song();
        theModel.addAttribute(song);

        return "albums/list-songs";
    }

    @GetMapping("/showFormForAddAlbum")
    public String showFormForAddAlbum(Model theModel) {
        Album album = new Album();
    ...
    public String showFormForUpdateAlbum(@RequestParam("albumId") int albumId, Model theModel) {
        // Get album by id
        Album album = albumService.findById(albumId);
